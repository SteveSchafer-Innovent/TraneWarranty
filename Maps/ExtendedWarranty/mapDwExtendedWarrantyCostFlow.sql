...
SELECT
	...
	INNER JOIN PROD_CODE_XREF_RCPO_DR /* -- -SS- OTR_PROD_CODE_XREF_RCPO */ PRODGRP 
		ON GLA.PS_COMPANY = PRODGRP.GL_LEDGER -- -SS- issue 22 -- SR-r12??? -- -SS- @DR_INTFC_DW.LAX.TRANE.COM
