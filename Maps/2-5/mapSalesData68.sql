SELECT
	...
	LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX  ON PS.PLNT_GL_BU = PX.GL_LEDGER AND PS.PLNT_GL_PROD = PX.ORA_PRODUCT -- -SS- MANF_PROD_CODE -> ORA_PRODUCT, FIXME join won't work as is
...
SELECT
	...
	LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX ON L.BUSINESS_UNIT = PX.GL_LEDGER AND L.R12_PRODUCT = PX.ORA_PRODUCT -- -SS- MANF_PROD_CODE -> ORA_PRODUCT
...
SELECT
	...
	LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX ON RS_LEDGER.R12_PRODUCT = PX.ORA_PRODUCT -- /* -SS- PRODUCT_ID, MANF_PROD_CODE */
	...
	FROM
		(
			SELECT
				...
				LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO X   ON A.R12_PRODUCT = X.ORA_PRODUCT -- /* -SS- IDENTIFIER, MANF_PROD_CODE */
