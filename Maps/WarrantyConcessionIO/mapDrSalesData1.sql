SELECT
	...
	(
	CASE
		WHEN PS.PART_TYPE = 'Y' AND PS.PARTS_PROD_CODE_IND = 'PCR' THEN '804900'
		ELSE PS.R12_PRODUCT
			-- -SS- GL_PROD
...
ON PS.R12_LOCATION = AOL.ORA_LOCATION -- -SS- PS.GL_DPT_ID = AOL.DEPT_ID
AND PS.R12_LOCATION = AOL.ORA_ENTITY   -- -SS- PS.GL_BU_ID = AOL.BU_UNIT (+)
...
SELECT
	...
	AS DIST_GL_PRODUCT,
	/* PER JACKIE'S EMAIL 5/9, FOLLOWING LOGIC IS NEEDED*/
	NVL(PX.PRODUCT_CATEGORY, 'INVALID PROD CODE - '|| L.R12_PRODUCT) AS RESERVE_GROUP, -- -SS- PRODUCT
...
FROM
	...
	LEFT OUTER JOIN ACTUATE_OFFICE_LOCATION AOL
	ON D.R12_LOCATION = AOL.ORA_LOCATION -- -SS- DEPTID, DEPT_ID, (+)
	AND D.R12_ENTITY  = AOL.ORA_ENTITY   -- -SS- BUSINESS_UNIT_GL, BU_UNIT, (+)
