CREATE OR REPLACE 
		...
		(
			...
			SELECT
				...
				INNER JOIN PROD_CODE_XREF_RCPO_DR PRODGRP ON PCS.PROD_CODE = PRODGRP.MANF_PROD_CODE AND GLA.PS_COMPANY = PRODGRP.GL_LEDGER    -- -SS- issues 55, 56 -- -SS- issue 22 -- SR-r12???
				...
				WHERE
					...
					--and CCN_DATA.CLAIM_NBR = 9018750
		)
	UNION
			(
