...
SELECT
	...
	FROM
		...
		CCN_DATA
	LEFT OUTER JOIN DM_FAL_CLAIMS_WARRANTY_XRF FCW AND CCN_DATA.CLAIM_NBR = FCW.CLAIM_NBR AND CCN_DATA.STEP_NBR = FCW.STEP_NBR
	...
	INNER JOIN ACTUATE_SEC_XREF ASX                 ON GLA.COMPANY = ASX.PSGL(+)
