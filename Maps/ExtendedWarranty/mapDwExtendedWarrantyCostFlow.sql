CREATE OR REPLACE VIEW MAP_EXTWARRANTYCOSTFLOW_VW AS 
SELECT
...
-- SR Not used - no affect	INNER JOIN CLAIM_TASK_SCD CTASKS           ON MLR.CLAIM_TASK_SCD_KEY = CTASKS.CLAIM_TASK_SCD_KEY
	...
	INNER JOIN PROD_CODE_XREF_RCPO_DR PRODGRP  /* -- -SS- OTR_PROD_CODE_XREF_RCPO */  -- -SS- issue 22 -- -SS- @DR_INTFC_DW.LAX.TRANE.COM
		ON PCS.PROD_CODE = PRODGRP.MANF_PROD_CODE AND GLA.PS_COMPANY = PRODGRP.GL_LEDGER -- SR-r12???                          -- -SS- issues 55, 56
