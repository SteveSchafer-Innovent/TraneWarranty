...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = L.R12_ACCOUNT
		-- -SS- /NEW
	LEFT OUTER JOIN R12_TRANE_PRODUCTS_PS PR   ON L.R12_PRODUCT = PR.R12_PRODUCT -- R12_2_R12_ok -- -SS- PRODUCT, (+), OTR
	LEFT OUTER JOIN R12_TRANE_DEPTS_PS DP      ON L.R12_LOCATION = DP.R12_LOCATION -- R12_2_R12_ok -- SS DEPTID (+)
...
SELECT
	...
	LEFT OUTER JOIN ACTUATE_SEC_XREF ASX ON PS.BUSINESS_UNIT = ASX.PSGL -- (+) -- -SS- issue 87
	WHERE
	...
	FROM
		(
			SELECT
				...
				LEFT OUTER JOIN R12_TRANE_DEPTS_PS DP ON D.R12_LOCATION = DP.R12_LOCATION -- R12_2_R12_ok  -- -SS- DEPTID -> R12_LOCATION 
