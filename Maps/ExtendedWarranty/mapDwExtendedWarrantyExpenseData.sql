CREATE OR REPLACE VIEW MAP_EXTWARRANTYEXPENSEDATA_VW AS 
SELECT
	...
	INNER JOIN PROD_CODE_XREF_RCPO_DR /* OTR_PROD_CODE_XREF_RCPO */ PRODGRP    
		ON PCS.PROD_CODE = PRODGRP.MANF_PROD_CODE AND GLA.PS_COMPANY = PRODGRP.GL_LEDGER -- SS - issue 22 -- -SS- issues 55, 56  -- SR-r12???
	...
	-- -SS- issue 88: INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON GLA.R12_ACCOUNT = PSA.R12_ACCOUNT -- R12_2_R12 -- /* -SS- ACCOUNT */ /* -SS- ACCOUNT */ (+) -- /* -SS- OTR @DR_INTFC_DW.LAX.TRANE.COM */
		-- -SS- NEW issue 88
