...
AND PS.PLNT_GL_PROD = PX.MANF_PROD_CODE -- SS- FIXME missing PLNT_GL_PROD on R12_ORACLE_PS_REV_RCPO
...
GROUP BY PS.GL_BU_ID,
	...
	(
	CASE
		WHEN PS.PART_TYPE = 'Y' AND PS.PARTS_PROD_CODE_IND = 'PCR' -- SS FIXME missing columns issue 55
		THEN '804900'
		ELSE PS.R12_PRODUCT
			-- -SS- GL_PROD
	END),
...
ON L.R12_LOCATION = DP.DEPTID -- -SS- DEPTID -> R12_LOCATION, FIXME this join won't work
LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX
...
ON PS.R12_PRODUCT = PR.R12_PRODUCT
	...
	-- -SS- OTR
LEFT OUTER JOIN OTR_TRANE_DEPTS_PS DP
ON PS.R12_LOCATION = DP.DEPTID -- -SS- DEPTID, FIXME join won't work
LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX
