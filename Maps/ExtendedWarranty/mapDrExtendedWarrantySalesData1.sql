SELECT
	...
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 -- -SS- issues 23, 35
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = A.R12_ACCOUNT
		-- -SS- /NEW
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 -- /* -SS- ACCOUNT */ /* -SS- ACCOUNT */ (+) -- /* -SS- OTR */
		/* --SS- ,dbo.ACTUATE_SEC_XREF ASX */
	WHERE
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = A.R12_ACCOUNT
		-- -SS- /NEW
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT -- R12_2_R12  -- -SS- OTR
...
INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON UPD.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 
	WHERE
