SELECT
	...
	INNER JOIN OTR_PROD_CODE_XREF_RCPO PRODGRP ON GLA.PS_COMPANY = PRODGRP.GL_LEDGER -- -SS- ???? issue 22 -- -SS- @DR_INTFC_DW.LAX.TRANE.COM
	...
	LEFT OUTER JOIN R12_TRANE_ACCOUNTS_PS PSA ON GLA.R12_ACCOUNT = PSA.R12_ACCOUNT AND PSA.TRANE_ACCOUNT_IND = 'X' -- R12_2_R12  -- -SS- OTR @DR_INTFC_DW.LAX.TRANE.COM
