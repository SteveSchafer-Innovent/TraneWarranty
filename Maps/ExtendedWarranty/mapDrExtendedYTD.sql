		...
		(
			...
			SELECT
				...
				INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = A.R12_ACCOUNT
					-- -SS- /NEW
				LEFT OUTER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT -- /* -SS- ACCOUNT */  -- /* -SS- OTR was PS_TRANE_ACCOUNTS */
