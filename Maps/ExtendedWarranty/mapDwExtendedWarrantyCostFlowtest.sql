CREATE OR REPLACE VIEW MAP_EXTWARRANTYCOSTFLOWTEST_VW AS 
SELECT
	...
	INNER JOIN PROD_CODE_XREF_RCPO_DR /* OTR_PROD_CODE_XREF_RCPO */ PRODGRP  -- -SS- @DR_INTFC_DW.LAX.TRANE.COM
