CREATE VIEW MAP_EXPENSEWARRANTYDATA68_VW AS
/* 2-5Year Specific */
SELECT
		/* + NO_CPU_COSTING  */
	...
	FROM
		(
			...
			SELECT
				...
				ON GLA.GL_ACCOUNT_SCD_KEY = MLR.GL_ACCOUNT_SCD_KEY AND GLA.GL_ACCOUNT_SCD_KEY = LR.GL_ACCOUNT_SCD_KEY
				INNER JOIN
			...
			(
				SELECT
					...
					INNER JOIN PROD_CODE_XREF_RCPO_DR PRODGRP
						-- FOR RESERVE GROUP
					ON 'CSD' = PRODGRP.GL_LEDGER -- -SS- issue 22
						AND PCS.PROD_CODE = PRODGRP.MANF_PROD_CODE -- -SS- issues 55, 56
