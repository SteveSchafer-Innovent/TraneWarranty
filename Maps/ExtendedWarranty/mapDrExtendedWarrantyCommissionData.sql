SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = DIST.R12_ACCOUNT
		-- -SS- /NEW
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON DIST.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12  -- -SS- OTR
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = DIST.R12_ACCOUNT
		-- -SS- /NEW
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON DIST.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 
		-- -SS- ,DBO.ACTUATE_SEC_XREF ASX
	WHERE
		-- -SS- DIST.ACCOUNT = PSA.ACCOUNT
		PSA.TRANE_ACCOUNT_IND = 'X'
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = GL_CODE.R12_ACCOUNT
		-- -SS- /NEW
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON GL_CODE.R12_ACCOUNT = PSA.R12_ACCOUNT -- R12_2_R12 -- /* -SS- ACCOUNT */ /* -SS- SEGMENT2 */ (+) --/* -SS- OTR */
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = GL_CODE.R12_ACCOUNT
		-- -SS- /NEW
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON GL_CODE.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 -- /* -SS- SEGMENT2 */ /* -SS- ACCOUNT */ (+)-- /* -SS- OTR */
		/* -SS- ,ACTUATE_SEC_XREF ASX */
	WHERE
		PSA.TRANE_ACCOUNT_IND = 'X'
		/* -SS- AND GL_CODE.SEGMENT1 = ASX.PSGL(+) */
...
SELECT
	...
	INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON UPD.GL_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 
	WHERE
