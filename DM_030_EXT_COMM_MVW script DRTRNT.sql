		...
		(
			SELECT
				...
				ON DIST.R12_ACCOUNT = PSA.R12_ACCOUNT -- -SS- R12_2_R12
					...
					-- -SS- NEW
				INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = DIST.R12_ACCOUNT -- -SS- R12_2_R12
					-- -SS- /NEW
				WHERE
			...
			SELECT
				...
				ON COMM.CODE_COMBINATION_ID = GL_CODE.CODE_COMBINATION_ID
					-- -SS- NEW
				INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = GL_CODE.R12_ACCOUNT -- -SS- R12_2_R12
					-- -SS- /NEW
			...
			SELECT DISTINCT
				...
				FROM
					MD_030_COMMISSION_DTL_UPD UPD
				LEFT OUTER JOIN R12_TRANE_ACCOUNTS_PS PSA -- -SS- OTR
				ON UPD.R12_ACCOUNT = PSA.R12_ACCOUNT AND PSA.TRANE_ACCOUNT_IND = 'X'
				WHERE
					-- -SS- upd.gl_account = PSA.ACCOUNT (+) AND
					UPD.JRNL_DATE BETWEEN '1-JAN-1998' AND '31-DEC-1999'
		)
