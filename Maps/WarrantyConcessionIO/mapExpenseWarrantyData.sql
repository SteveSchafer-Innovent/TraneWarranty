...
AND (GLA.ACCOUNT LIKE '0620%' OR  GLA.ACCOUNT LIKE '8062%')
...
,(SELECT DISTINCT CLAIM_NBR,DETAIL_NBR,STEP_NBR,APPR_AMT ,CCN_TRX_DATE_KEY FROM WC_LABOR_ROLLUP LR1 WHERE CLAIM_TYPE_SCD_KEY=11
    and exists (select 'X' from GL_ACCOUNT_SCD where lr1.GL_ACCOUNT_SCD_KEY=GL_ACCOUNT_SCD_KEY AND (ACCOUNT  LIKE '0620%' OR  ACCOUNT LIKE '8062%'))) LR2
