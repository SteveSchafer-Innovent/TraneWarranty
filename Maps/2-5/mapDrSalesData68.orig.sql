...
-- PER PAT'S REQUEST 5/30/07
 ,(CASE WHEN PS.PART_TYPE = 'Y' AND PS.PARTS_PROD_CODE_IND = 'PCR' THEN '804900' ELSE PS.GL_PROD END) AS DIST_GL_PRODUCT
...
,(CASE WHEN PS.PART_TYPE = 'Y' AND PS.PARTS_PROD_CODE_IND = 'PCR' THEN '804900' ELSE PS.GL_PROD END) 
,PS.GL_PROD
,PX.PRODUCT_CATEGORY
,PS.JRNL_DATE
...
/* PER JACKIE'S EMAIL 5/9, FOLLOWING LOGIC IS NEEDED*/
,NVL(PX.PRODUCT_CATEGORY,(CASE WHEN RS_LEDGER.PRODUCT_id = 'ELIM' OR RS_LEDGER.PRODUCT_id = 'TNA0' THEN 'LARGE' ELSE 'INVALID PROD CODE - '|| RS_LEDGER.PRODUCT_id END)) AS RESERVE_GROUP
--,PX.PRODUCT_CATEGORY AS RESERVE_GROUP
...
where  
 RS_LEDGER.PRODUCT_id = PR.PRODUCT(+)
AND  RS_LEDGER.DEPT_ID = DP.DEPTID(+)
AND  RS_LEDGER.PRODUCT_id = PX.MANF_PROD_CODE(+)
...
SELECT  /*+ NO_CPU_COSTING */  D.BUSINESS_UNIT_GL AS BUSINESS_UNIT, 
       ...
       CASE WHEN D.PRODUCT = '0064' THEN '804155' 
            ELSE D.PRODUCT END AS GL_PRODCODE, 
...
and A.IDENTIFIER=X.MANF_PROD_CODE (+) 
and X.GL_LEDGER = 'CSD'
/* New Logic Adedd as of Oct27-2010 as  Jackie Req  */ 
