SELECT
	...
	LEFT OUTER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT AND PSA.TRANE_ACCOUNT_IND = 'X' -- R12_2_R12 -- -SS- issues 23, 35
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = DIST.R12_ACCOUNT
		-- -SS- /NEW
	LEFT OUTER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT AND PSA.TRANE_ACCOUNT_IND = 'X' -- R12_2_R12  -- -SS- OTR
