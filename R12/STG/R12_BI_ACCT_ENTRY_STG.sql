...
ON RCTGD_REC.CUSTOMER_TRX_ID = RCT.CUSTOMER_TRX_ID

INNER JOIN
XLA_DISTRIBUTION_LINKS XDL_REC
ON RCTGD_REC.CUST_TRX_LINE_GL_DIST_ID = XDL_REC.SOURCE_DISTRIBUTION_ID_NUM_1
