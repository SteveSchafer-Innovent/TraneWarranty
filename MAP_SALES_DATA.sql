CREATE TABLE MAP_SALES_DATA (
	...
	BU VARCHAR2(5),
	REVENUE_AMOUNT NUMBER(26,3),
	REVENUE_AMOUNT_DEC NUMBER(26,3),
	GL_ACCOUNT VARCHAR2(10),
	DEPT_ID VARCHAR2(10),
	DEPT_DESCR VARCHAR2(240),
	MANF_PROD_ID VARCHAR2(6),
	MANF_PROD_DESCR VARCHAR2(50),
	DIST_GL_PRODUCT VARCHAR2(6),
	RESERVE_GROUP VARCHAR2(5),
	JRNL_DATE DATE,
	JRNL_YEAR INTEGER,
	JRNL_MONTH INTEGER,
	JRNL_YEAR_MONTH INTEGER,
	JRNL_ID VARCHAR2(10),
	CURRENCY VARCHAR2(3),
	COUNTRY_INDICATOR VARCHAR2(3),
	TWO_FIVE VARCHAR2(1)
);
...
SELECT
	...
	LEFT OUTER JOIN R12_TRANE_LOCATIONS DP ON DP.R12_LOCATION = PS.R12_LOCATION
	WHERE
		PS.JRNL_DATE BETWEEN TO_DATE('01/01/2005', 'MM/DD/YYYY') AND LAST_DAY(ADD_MONTHS(SYSDATE, - 1))
		AND PS.R12_ENTITY IN('5773', '5588', '5575', '5612', '5743', '9256', '9258', '9298', '9299') -- -SS- CAN, USA
	GROUP BY
		PS.GL_BU_ID,
		PS.R12_ACCOUNT,
		PS.R12_LOCATION,
