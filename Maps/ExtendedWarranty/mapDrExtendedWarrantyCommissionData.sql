...
AND((DIST.PS_ACCOUNT IS NULL
AND AFU.LIKE_52 = 'Y')
OR(DIST.PS_ACCOUNT IS NOT NULL
...
SELECT
	...
	GL_CODE.R12_ENTITY AS BU, -- -SS- SEGMENT1
	GL_CODE.R12_ACCOUNT AS GL_ACCOUNT, -- -SS- SEGMENT2
	GL_CODE.R12_LOCATION AS GL_DEP_ID, -- -SS- SEGMENT3
	'P/S LEDGER' AS QUERY_SOURCE,
	GL_CODE.R12_PRODUCT AS GL_PRODUCT_ID, -- -SS- SEGMENT4
...
INNER JOIN R12_GL_CODE_COMBINATIONS GL_CODE
ON
	COMM.CODE_COMBINATION_ID = GL_CODE.CODE_COMBINATION_ID --/* -SS- */
INNER JOIN R12_ACCOUNT_FILTER_UPD AFU
ON
...
WHERE
	-- -SS- GL_CODE.SEGMENT2 = PSA.ACCOUNT
	-- -SS- and PSA.TRANE_ACCOUNT_IND = 'X'
	-- -SS- AND GL_CODE.SEGMENT1 = ASX.PSGL(+)
	COMM.GL_POSTED_DATE BETWEEN TO_DATE('1/01/2000', 'MM/DD/YYYY') AND TO_DATE('10/31/2004', 'MM/DD/YYYY')
AND((GL_CODE.PS_SEGMENT2 IS NULL
AND AFU.LIKE_52 = 'Y')
OR(GL_CODE.PS_SEGMENT2 IS NOT NULL
...
OR(GL_CODE.PS_SEGMENT3 IS NOT NULL
...
FROM
	BH.CMS_COMMISSION_DISTRIBUTIONS COMM
INNER JOIN R12_GL_CODE_COMBINATIONS GL_CODE -- -SS- OTR
ON
