			...
			FROM
				(
					...
					SELECT
						...
						INNER JOIN PROD_CODE_XREF_RCPO_DR PRODGRP ON PCS.PROD_CODE = PRODGRP.MANF_PROD_CODE                                     -- -SS- issues 55, 56
					...
					SELECT
						...
						WHERE
							...
							CASE WHEN CACCT.CUST_CREDIT_CATG_CODE = 'Z1'
								...
								ELSE 'N'
							END) = RES_PCT.CUST_CREDIT_CATG_CODE
							-- AND GLA.PS_COMPANY = PRODGRP.GL_LEDGER     -- -SS- issue 22, SR-R12???
