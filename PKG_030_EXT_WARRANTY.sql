...
***********************************************************************************/
	...
	WITH LAG_RULES AS
		...
		ON GLA.R12_ACCOUNT /* -SS- ACCOUNT */ = PSA.R12_ACCOUNT /* -SS- ACCOUNT */
		/* -SS- CROSS JOIN ???? ACTUATE_SEC_XREF ASX */
		...
		WHERE /* -SS- GLA.COMPANY =(
			...
			END)
		AND */ 
		    GLA.R12_ACCOUNT /* -SS- ACCOUNT */ = ART.GL_ACCOUNT
...
***********************************************************************************/
	...
	WITH GL_ACCOUNT_FILTER AS
		...
		ON GLA1.ACCOUNT = ART.gl_account
		)
	...
	ON GLA.R12_ENTITY /* -SS- COMPANY */ = PRODGRP.GL_LEDGER /* -SS- FIXME */
