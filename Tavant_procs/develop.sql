...
TO_NUMBER(TO_CHAR(TO_DATE(EXT2.TRX_DATE), 'YYYY')) * 100 + TO_NUMBER(TO_CHAR(TO_DATE(EXT2.TRX_DATE), 'MM')) AS TRXYEARMONTH,
...
CASE WARRANTY_TYPE
	...
	CASE WHEN INSTR(UPPER(DEALER) = 'INDEPENDENT' THEN 1 ELSE 0 END AS COMPANY_OWNED
FROM (
