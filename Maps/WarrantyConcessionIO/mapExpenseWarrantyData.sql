...
,case when  a.CLAIM_NUMBER is null   then 10000*( RES_PCT.RESERVE_PCT  )  else  res_PCT1.RESERVE_PCT end AS IN_RESERVE_PERCENT
...
,(SELECT DISTINCT CLAIM_NBR,DETAIL_NBR,STEP_NBR,APPR_AMT ,CCN_TRX_DATE_KEY FROM WC_LABOR_ROLLUP LR1 WHERE CLAIM_TYPE_SCD_KEY=11
    and exists (select 'X' from R12_GL_ACCOUNT_SCD /* -SS- */ where lr1.GL_ACCOUNT_SCD_KEY=GL_ACCOUNT_SCD_KEY AND (R12_ACCOUNT /* -SS- ACCOUNT */  LIKE '0620%' /* -SS- ???? */ OR  R12_ACCOUNT /* -SS- ACCOUNT */ LIKE '8062%' /* -SS- ???? */ ))) LR2
...
,case when  a.CLAIM_NUMBER is null   then 10000*( RES_PCT.RESERVE_PCT  )  else  res_PCT1.RESERVE_PCT end
...
,LR.FAIL_DATE_KEY
,LR.START_DATE_KEY
,LR.GL_ACCOUNT_SCD_KEY /* GL_ACCOUNT_SCD.GL_ACCOUNT_SCD_KEY */
...
,(SELECT  /*+  no_cpu_costing */   DISTINCT CLAIM_NBR, STEP_NBR,WA_POLICY_TYPE,WA_RANGE FROM DM_FAL_CLAIMS_WARRANTY_XRF ) FCW
,TIME_DAY TD3
,TIME_DAY TD2
,TIME_DAY TD1
,TIME_DAY TD
