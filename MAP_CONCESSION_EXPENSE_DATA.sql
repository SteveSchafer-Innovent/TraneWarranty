...
INSERT /*+ APPEND */ INTO MAP_CONCESSION_EXPENSE_DATA
SELECT
		/*+ NO_CPU_COSTING */
	...
	FROM
		(
			...
			SELECT
				...
				WHERE
					...
					*/
					...
					--AND CT.CLAIM_TYPE_CODE ='CONCESSION'
					-- -SS- NEW
					AND AFU.EQUAL_428000 = 'Y' -- SR One to One Match
					-- -SS- /NEW
			...
			SELECT
				...
				INNER JOIN
					(SELECT DISTINCT CLAIM_NBR, DETAIL_NBR, STEP_NBR, APPR_AMT FROM WC_LABOR_ROLLUP LR1 WHERE CLAIM_TYPE_SCD_KEY = 11 AND EXISTS
								(SELECT 'X' FROM R12_GL_ACCOUNT_SCD DIST -- -SS- OCD
											-- -SS- NEW
										...
										WHERE
											LR1.GL_ACCOUNT_SCD_KEY = GL_ACCOUNT_SCD_KEY
											-- -SS- NEW
											AND AFU.EQUAL_428000 = 'Y' -- SR One to One
											-- -SS- /NEW
...
SELECT
	...
	WHERE
		...
		-- -SS- NEW
		AND (AFU.EQUAL_428000 = 'Y' OR AFU.EQUAL_710000 = 'Y' OR AFU.EQUAL_806300 = 'Y')
