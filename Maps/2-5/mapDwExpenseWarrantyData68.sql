	...
	UNION
			(
				...
				SELECT
					...
					INNER JOIN PROD_CODE_XREF_RCPO_DR PRODGRP ON PCS.PROD_CODE = PRODGRP.MANF_PROD_CODE AND GLA.PS_COMPANY = PRODGRP.GL_LEDGER -- SS - issue 22 -- -SS- issues 55, 56  -- SR-r12???
						-- -SS- ,ACTUATE_SEC_XREF ASX
				...
				(
					...
					SELECT
						...
						INNER JOIN SUBMIT_OFFICE_SCD SOS  ON CCN_DATA.SUBMIT_OFFICE_SCD_KEY = SOS.SUBMIT_OFFICE_SCD_KEY
							-- -SS- ,ACTUATE_SEC_XREF ASX
						INNER JOIN PROD_CODE_XREF_RCPO_DR PRODGRP ON  -- -SS- issue 22
							PCS.PROD_CODE = PRODGRP.MANF_PROD_CODE                            -- -SS- issues 55, 56 -- FOR RESERVE GROUP
							AND GLA.PS_COMPANY = PRODGRP.GL_LEDGER											-- SR-r12???
