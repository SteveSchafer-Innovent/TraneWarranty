...
SELECT /*+ FIRST_ROWS */  
CASE WHEN A.R12_ENTITY NOT IN ('5773', '5588') /* -SS- ASX.NATION_CURR ='USD' */ THEN 'USA' ELSE 'CAN' END AS COUNTRY_INDICATOR,
...
AND CASE WHEN A.R12_ENTITY NOT IN ('5773', '5588') /* -SS- ASX.NATION_CURR ='USD' */ THEN 'USA' ELSE 'CAN' END = UPPER(:COUNTRY)
...
GROUP BY 
CASE WHEN A.R12_ENTITY NOT IN ('5773', '5588') THEN 'USA' ELSE 'CAN' END /* -SS- ASX.NATION_CURR */  ,
