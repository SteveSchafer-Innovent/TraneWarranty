...
WHERE
DIST.R12_ACCOUNT /* -SS- ACCOUNT */ = PSA.ACCOUNT
...
gl_code.SEGMENT1 as BU,
GL_CODE.SEGMENT2 AS GL_ACCOUNT,
GL_CODE.SEGMENT3 AS GL_DEP_ID,
'P/S LEDGER' as QUERY_SOURCE,
GL_CODE.SEGMENT4 AS GL_PRODUCT_ID,
...
and ( GL_CODE.SEGMENT3 IS NULL OR (GL_CODE.SEGMENT3 = 'TCA0') OR (GL_CODE.SEGMENT3 = 'SL00') )
