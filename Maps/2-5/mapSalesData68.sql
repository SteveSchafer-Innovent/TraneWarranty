...
SELECT
	...
	LEFT OUTER JOIN R12_TRANE_PRODUCTS_PS PR   ON L.R12_PRODUCT = PR.R12_PRODUCT                                                                                                            -- /* -SS- PRODUCT */ /* -SS- PRODUCT */    -- /* -SS- OTR */
	LEFT OUTER JOIN OTR_TRANE_DEPTS_PS DP      ON L.R12_LOCATION = DP.DEPTID                                                                                                                -- /* -SS- DEPTID */
	LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX ON L.BUSINESS_UNIT = PX.GL_LEDGER AND L.R12_PRODUCT = PX.MANF_PROD_CODE                                                                      -- /* -SS- PRODUCT */
...
SELECT
	...
	LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX ON PS.R12_PRODUCT = PX.MANF_PROD_CODE -- /* -SS- PRODUCT */
...
SELECT
		...
		,
		NVL(PX.PRODUCT_CATEGORY,(
		CASE WHEN RS_LEDGER.R12_PRODUCT
				/* -SS- PRODUCT_ID */
				= 'ELIM'
				/* -SS- ???? */
	...
	LEFT OUTER JOIN R12_TRANE_PRODUCTS_PS PR   ON RS_LEDGER.R12_PRODUCT = PR.R12_PRODUCT    -- /* -SS- PRODUCT_ID */ /* -SS- PRODUCT */   --/* -SS- OTR */
	LEFT OUTER JOIN OTR_TRANE_DEPTS_PS DP      ON RS_LEDGER.R12_LOCATION = DP.DEPTID(+)     -- /* -SS- DEPT_ID */
	LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX ON RS_LEDGER.R12_PRODUCT = PX.MANF_PROD_CODE -- /* -SS- PRODUCT_ID */
	...
	FROM
		(
			SELECT
				...
				LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO X   ON A.R12_PRODUCT = X.MANF_PROD_CODE                                                                -- /* -SS- IDENTIFIER */
	...
	FROM
		(
			SELECT
				...
				LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO X   ON A.R12_PRODUCT = X.MANF_PROD_CODE  -- /* -SS- IDENTIFIER */
				LEFT OUTER JOIN R12_TRANE_PRODUCTS_PS PR    ON D.R12_PRODUCT = PR.R12_PRODUCT    -- /* -SS- OTR */  -- /* -SS- PRODUCT */
