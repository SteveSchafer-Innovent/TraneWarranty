...
SELECT
	...
	FROM
		...
		CCN_DATA
	LEFT OUTER JOIN DM_FAL_CLAIMS_WARRANTY_XRF FCW ON CCN_DATA.CLAIM_NBR = FCW.CLAIM_NBR AND CCN_DATA.STEP_NBR = FCW.STEP_NBR -- AND CCN_DATA.DETAIL_NBR=FCW.DETAIL_NBR  -- CONCESSION CLAIM TYPE
...
SELECT
	...
	FROM
		WC_MAT_LBR_ROLLUP MLR
		-- SR - NOT USED INNER JOIN EXPENSE_TYPE_SCD ET                 ON MLR.EXPENSE_TYPE_SCD_KEY = ET.EXPENSE_TYPE_SCD_KEY
	...
	WHERE
		...
		-- -SS- NEW
		-- SR -- PeopleSoft Only. May need to replace
		/*
		AND((GLA.PS_ACCOUNT = 'NA' AND AFU.STANDARD_WARRANTY_EXPENSE = 'Y')
		OR GLA.PS_ACCOUNT LIKE '0620%'
		OR GLA.PS_ACCOUNT LIKE '8062%')
		*/
		-- AND(GLA.PS_ACCOUNT LIKE '0620%' OR GLA.PS_ACCOUNT LIKE '8062%')  -- SR Optimize
		AND GLA.PS_ACCOUNT IN('062000', '062004', '062005', '806200', '806201', '806202', '806204', '806205', '806207', '806208')
		-- -SS- /NEW
		-- -SS- AND(GLA.ACCOUNT LIKE '0620%' OR GLA.ACCOUNT LIKE '8062%')
	GROUP BY
