...
inner join OTR_PROD_CODE_XREF_RCPO PRODGRP on GLA.R12_ENTITY =PRODGRP.GL_LEDGER -- /* -SS- COMPANY */
...
inner join DM_WAR_CSN_RSV_PCT_REF RES_PCT ON CTYPES.CLAIM_TYPE_DESCR = RES_PCT.CLAIM_TYPE AND ETS.EXPENSE_TYPE_DESCR=RES_PCT.EXPENSE_TYPE_DESCR
...
AND TD3.FULL_DATE>=TO_DATE('1/01/2000','MM/DD/YYYY') AND TD3.FULL_DATE<= TO_DATE('12/31/2050','MM/DD/YYYY')
