...
COMMIT;
SELECT TO_CHAR (SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "SECTION 1 - CONCESSION EXPENSE"  FROM DUAL;
INSERT /*+ APPEND */
...
SELECT 
	...
	WHERE(
		...
		-- and ccn_data.claim_nbr in (9318374,9382878,9396529,9434401)
		;
COMMIT;
/* Core Portion for Material */
SELECT TO_CHAR (SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "SECTION 2 - CONCESSION EXPENSE"  FROM DUAL;
INSERT /*+ APPEND */
	INTO MAP_CONCESSION_EXPENSE_DATA
SELECT 
		/*+ NO_CPU_COSTING */
...
-- SR Not used - No affect	INNER JOIN CLAIM_TASK_SCD CTASKS                ON MLR.CLAIM_TASK_SCD_KEY = CTASKS.CLAIM_TASK_SCD_KEY
	...
	WHERE
		...
		OR AFU.EQUAL_806300 = 'Y')
		-- AND MLR.CLAIM_NBR IN (9318374,9382878,9396529,9434401)
		;
COMMIT;
SELECT TO_CHAR (SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "FINISH - CONCESSION EXPENSE"  FROM DUAL;
