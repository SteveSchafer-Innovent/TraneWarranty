...
DIST_GL_PRODUCT, ( Case When SalesDataReport.RESERVE_GROUP in ( 'LARGE' , 'Large')  Then 'Large'  
Else 'Light'  End
...
REVENUE_AMOUNT_DEC
FROM 
"InformationObjects/2-5 Year Standard Warranty/Information Objects/SalesDataReport68.iob"  AS SalesDataReport
