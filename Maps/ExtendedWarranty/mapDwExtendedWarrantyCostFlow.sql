SELECT
		...
		CASE WHEN GLA.R12_ENTITY NOT IN('5773', '5588')
			THEN 'USA' -- /* -SS- ASX.NATION_CURR='USD' */
			ELSE 'CAN'
				/* -SS-
	...
	INNER JOIN PROD_CODE_XREF_RCPO_DR /* -- -SS- OTR_PROD_CODE_XREF_RCPO */ PRODGRP ON 'CSD' = PRODGRP.GL_LEDGER -- -SS- issue 22 -- -SS- @DR_INTFC_DW.LAX.TRANE.COM
	...
	-- -SS- issue 88: INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON GLA.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12  -- -SS- OTR @DR_INTFC_DW.LAX.TRANE.COM
	...
	WHERE
		...
		AND(AFU.EQUAL_523500 = 'Y'
		OR AFU.EQUAL_526892 = 'Y'
		OR AFU.EQUAL_526893 = 'Y'
		OR AFU.EQUAL_528100 = 'Y'
		OR AFU.EQUAL_528200 = 'Y'
		OR AFU.EQUAL_528300 = 'Y'
		OR AFU.EQUAL_532100 = 'Y'))
