...
SELECT
		...
		(
			...
			SELECT
					...
					CASE TAVANT_WARRANTY_TYPE 
						...
						WHEN 'GOODWILL' THEN CASE WHEN TRUNC(FAILURE_DATE) - TRUNC(SHIP_DATE) < 548
							THEN '<'
							ELSE '>'
							END
						ELSE CASE   
	...
	LEFT OUTER JOIN (
		SELECT EXPENSE_TYPE_DESCR, EXPENSE_TYPE_CATG, COMPANY_OWNED_IND, CUST_CREDIT_CATG_CODE, CLAIM_TYPE, RESERVE_PCT
			...
			AND CASE EXT2.CREDIT_TO_THIRD_PARTY
				WHEN 'N' THEN 'Y'
				ELSE 'N'
				END =  RES_PCT.CUST_CREDIT_CATG_CODE
			AND CASE EXT2.CLAIM_TYPE
				WHEN 'EXT' THEN CASE UPPER(EXT2.MATERIAL_LABOR)
