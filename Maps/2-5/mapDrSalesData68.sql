...
SELECT
	...
	LEFT OUTER JOIN OTR_TRANE_DEPTS_PS DP      ON L.R12_LOCATION = DP.DEPTID     -- R12_2_R12  -- -SS- DEPTID -> R12_LOCATION, ???? issue 69
...
SELECT
	...
	LEFT OUTER JOIN R12_TRANE_PRODUCTS_PS PR ON PS.R12_PRODUCT = PR.R12_PRODUCT -- R12_2_R12 
		...
		-- -SS- PRODUCT
		-- -SS- OTR
	LEFT OUTER JOIN OTR_TRANE_DEPTS_PS DP      ON PS.R12_LOCATION = DP.DEPTID -- -SS- DEPTID, ???? issue 69
