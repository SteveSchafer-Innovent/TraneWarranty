...
GROUP BY A.R12_ACCOUNT,PSA.DESCR, CASE WHEN A.r12_entity IN (5773, 5588) THEN 'CAN' ELSE 'USA' END
...
/*TAY: FROM OTR_BI_ACCT_ENTRY_PSB dist,
    ...
    FROM R12_BI_ACCT_ENTRY_PSB dist,
         --dbo.ACTUATE_SEC_XREF ASX,
         R12_BI_HDR_PSB C 
    WHERE /*TAY: DIST.BUSINESS_UNIT_GL= ASX.PSGL   
...
/*TAY:      AND dist.BUSINESS_UNIT = C.BUSINESS_UNIT*/
      AND dist.BUSINESS_UNIT = C.PS_BUSINESS_UNIT 
