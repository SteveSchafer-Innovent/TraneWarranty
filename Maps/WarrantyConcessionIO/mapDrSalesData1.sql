...
FROM OTR_ORACLE_PS_REV_RCPO PS -- SS FIXME not changed to OTR
...
ON PS.GL_DPT_ID = AOL.ORA_LOCATION -- -SS- FIXME, DEPT_ID, (+)
AND PS.GL_BU_ID = AOL.ORA_ENTITY   -- -SS- FIXME, BU_UNIT, (+)
...
ON L.R12_LOCATION = DP.DEPTID -- SS FIXME not changed to R12 -- R -SS- DEPTID, (+)
LEFT OUTER JOIN OTR_PROD_CODE_XREF_RCPO PX
