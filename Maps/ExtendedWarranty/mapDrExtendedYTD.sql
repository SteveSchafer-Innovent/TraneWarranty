		...
		(
			...
			SELECT
				...
				INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = L.R12_ACCOUNT
					-- -SS- /NEW
				-- -SS- LEFT OUTER JOIN ACTUATE_SEC_XREF ASX ON L.BUSINESS_UNIT = ASX.PSGL -- -SS- issue 87
				WHERE
					...
					AND
					CASE
						WHEN L.BUSINESS_UNIT = 'CSD' THEN 'USD'
						WHEN L.BUSINESS_UNIT = 'CAN' THEN 'CAD'
						ELSE ''
						END = UPPER(:COUNTRY) -- -SS- issue 87
					/*
		...
		(
			...
			SELECT
				...
				INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = A.R12_ACCOUNT
					-- -SS- /NEW
				-- -SS- issue 88: LEFT OUTER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT -- R12_2_R12 -- /* -SS- ACCOUNT */  -- /* -SS- OTR was PS_TRANE_ACCOUNTS */
