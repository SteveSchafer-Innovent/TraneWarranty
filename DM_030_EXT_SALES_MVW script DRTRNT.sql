	...
	FROM
		(
			...
			SELECT
				...
				INNER JOIN R12_BI_HDR_PSB C               ON B.BUSINESS_UNIT = C.PS_BUSINESS_UNIT AND B.INVOICE = C.INVOICE AND C.ENTRY_TYPE = 'IN'
				INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON A.R12_ACCOUNT = PSA.R12_ACCOUNT -- -SS- R12_2_R12
					-- -SS- OTR
					/* -SS- ,
					DBO.ACTUATE_SEC_XREF ASX */
				WHERE
			...
			SELECT
				...
				INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON UPD.GL_ACCOUNT = PSA.R12_ACCOUNT -- -SS- ???? issue 80, R12_2_R12
					-- -SS- OTR
				WHERE
