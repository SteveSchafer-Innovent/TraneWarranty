...
TRUNCATE TABLE MAP_WARRANTY_EXPENSE_DATA_SS DROP STORAGE;
COMMIT;
-- SECTION 1 - pre-load
...
SELECT TO_CHAR(SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "Start SECTION 1 - preload 2"  FROM DUAL;
INSERT /*+ APPEND */
	INTO MAP_CCN_DATA
			SELECT DISTINCT
					/*+  no_cpu_costing */
...
SELECT TO_CHAR (SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "Start SECTION 1"  FROM DUAL;
INSERT /*+ APPEND */
...
SELECT TO_CHAR(SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "Start SECTION 2"  FROM DUAL;
/* Material and Retrofit Material */
INSERT /*+ APPEND */	INTO	MAP_WARRANTY_EXPENSE_DATA_SS
SELECT DISTINCT
		/*+  no_cpu_costing */
...
SELECT TO_CHAR (SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "Start SECTION 3 - preload"  FROM DUAL;
TRUNCATE TABLE MAP_CCN_DATA;
commit;
...
SELECT TO_CHAR (SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "Start SECTION 3"  FROM DUAL;
INSERT /*+ APPEND */
	INTO MAP_WARRANTY_EXPENSE_DATA_SS
SELECT 
		/*+ NO_CPU_COSTING */
...
SELECT TO_CHAR
    (SYSDATE, 'MM-DD-YYYY HH24:MI:SS') "Finish"
     FROM DUAL;
commit;
