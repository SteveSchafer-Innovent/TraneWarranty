...
SELECT
		...
		'ACTUALS' AS LEDGER,
		(RCTGD.AMOUNT * - 1) AS MONETARY_AMOUNT,
	...
	LEFT OUTER JOIN XLA_DISTRIBUTION_LINKS XDL_REC    ON RCTGD_REC.CUST_TRX_LINE_GL_DIST_ID = XDL_REC.SOURCE_DISTRIBUTION_ID_NUM_1 AND RCTGD.EVENT_ID = XDL_REC.EVENT_ID
	LEFT OUTER JOIN XLA_DISTRIBUTION_LINKS XDL        ON RCTGD.CUST_TRX_LINE_GL_DIST_ID = XDL.SOURCE_DISTRIBUTION_ID_NUM_1 AND RCTGD.EVENT_ID = XDL.EVENT_ID
	LEFT OUTER JOIN XLA_AE_LINES AEL                  ON XDL.AE_HEADER_ID = AEL.AE_HEADER_ID AND XDL.AE_LINE_NUM = AEL.AE_LINE_NUM
	...
	LEFT OUTER JOIN GL_JE_BATCHES GJB                 ON GJB.JE_BATCH_ID = GJH.JE_BATCH_ID
	WHERE
		0 = 0
		AND RCT.COMPLETE_FLAG = 'Y'
		AND RCT.ORG_ID IN(456, 457)
		AND RBS.BATCH_SOURCE_ID IN('90003', '90006', '87004', '87003', '90005', '93003')
		AND RCTL.LINE_TYPE = 'LINE'
		AND NVL(RCTGD.LATEST_REC_FLAG, 'Y') = 'Y'
		--  AND XDL.SOURCE_DISTRIBUTION_TYPE = 'RA_CUST_TRX_LINE_GL_DIST_ALL'
		--  AND XDL.APPLICATION_ID = 222
		--  AND GJH.JE_SOURCE = 'Receivables'
		AND RBS.NAME IN('P21', 'ORDER ENTRY', 'TCS MANUAL', 'HVAC TAVANT')
		...
		AND RCT.INTERFACE_HEADER_ATTRIBUTE1 LIKE 'C-20000433%' -- 'C-20000313%' 
