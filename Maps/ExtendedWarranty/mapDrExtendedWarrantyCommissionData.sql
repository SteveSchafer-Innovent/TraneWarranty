CREATE OR REPLACE VIEW MAP_EXTWARRANTYCOMMNDATA_VW AS 
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = DIST.R12_ACCOUNT
		-- -SS- /NEW
	-- -SS- issue 88: INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON DIST.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12  -- -SS- OTR
	...
	WHERE 1=1
		...
		AND DIST.R12_ENTITY IN('5575', '5612', '5743', '9256', '9258', '9298', '9299', '9984') -- -SS- ASX.NATION_CURR = 'USD'
		-- -SS- NEW
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = DIST.R12_ACCOUNT
		-- -SS- /NEW
	-- -SS- issue 88: INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON DIST.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 
		-- -SS- ,DBO.ACTUATE_SEC_XREF ASX
	WHERE 1=1
		-- -SS- DIST.ACCOUNT = PSA.ACCOUNT
		-- -SS- issue 88: PSA.TRANE_ACCOUNT_IND = 'X'
...
SELECT
	...
	INNER JOIN BH.R12_GL_CODE_COMBINATIONS GL_CODE ON COMM.CODE_COMBINATION_ID = GL_CODE.CODE_COMBINATION_ID -- -SS-
		-- -SS- NEW
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = GL_CODE.R12_ACCOUNT
		-- -SS- /NEW
	-- -SS- issue 88: INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON GL_CODE.R12_ACCOUNT = PSA.R12_ACCOUNT -- R12_2_R12 -- /* -SS- ACCOUNT */ /* -SS- SEGMENT2 */ (+) --/* -SS- OTR */
	...
	WHERE 1=1
		...
		AND GL_CODE.R12_ENTITY IN ('5575', '5612', '5743', '9256', '9258', '9298', '9299', '9984') 
...
SELECT
	...
	WHERE 1=1
		...
		AND GL_CODE.R12_ENTITY IN ('5575', '5612', '5743', '9256', '9258', '9298', '9299', '9984')  -- /* -SS- AND ASX.NATION_CURR = 'USD' */
		-- -SS- NEW
		AND((GL_CODE.PS_SEGMENT3 = 'NA'
		AND(GL_CODE.R12_LOCATION IS NULL
		OR GL_CODE.R12_LOCATION IN('113602', '115615', '119001', '119007', '129001', '129003', '129004')))
...
SELECT
	...
	INNER JOIN R12_ACCOUNT_FILTER_UPD AFU ON AFU.R12_ACCOUNT = GL_CODE.R12_ACCOUNT
		-- -SS- /NEW
	-- -SS- issue 88: INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON GL_CODE.R12_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 -- /* -SS- SEGMENT2 */ /* -SS- ACCOUNT */ (+)-- /* -SS- OTR */
		/* -SS- ,ACTUATE_SEC_XREF ASX */
	WHERE 1=1
		-- -SS- issue 88: PSA.TRANE_ACCOUNT_IND = 'X'
		/* -SS- AND GL_CODE.SEGMENT1 = ASX.PSGL(+) */
...
SELECT
	...
	-- -SS- issue 88: INNER JOIN R12_TRANE_ACCOUNTS_PS PSA ON UPD.GL_ACCOUNT = PSA.R12_ACCOUNT  -- R12_2_R12 
		-- -SS- NEW
