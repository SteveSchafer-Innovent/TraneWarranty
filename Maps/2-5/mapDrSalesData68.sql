SELECT
	...
	LEFT OUTER JOIN R12_TRANE_DEPTS_PS DP ON DP.R12_LOCATION = PS.R12_LOCATION -- -SS- R12_2_R12, issue 47
...
SELECT
	...
	LEFT OUTER JOIN ACTUATE_SEC_XREF ASX       ON PS.BUSINESS_UNIT = ASX.PSGL -- -SS- ???? issue
	WHERE
	...
	FROM
		(
			SELECT
				...
				LEFT OUTER JOIN R12_TRANE_DEPTS_PS DP ON DP.R12_LOCATION = D.R12_LOCATION -- -SS- R12_2_R12, issue 47
					-- -SS- ACTUATE_OFFICE_LOCATION AOL
