...
FROM
	...
	AND
		CASE
			...
			ELSE 'CAN'
		END = UPPER(:COUNTRY)
	GROUP BY L.R12_ACCOUNT, -- -SS- ACCOUNT
		L.FISCAL_YEAR,
		L.LEDGER
	) BEGBALANCES
LEFT OUTER JOIN
	...
	INNER JOIN OTR_JRNL_HEADER_PS GA
	...
	GROUP BY L.R12_ACCOUNT,
		GA.FISCAL_YEAR,
		L.LEDGER
	) PERIODDATA ON BEGBALANCES.R12_ACCOUNT = PERIODDATA.R12_ACCOUNT
...
INNER JOIN
	...
	SELECT
		/*+ FIRST_ROWS */
		CASE
			WHEN A.R12_ENTITY NOT IN('5773', '5588')
	...
	ON A.R12_ACCOUNT = PSA.R12_ACCOUNT -- /* -SS- ACCOUNT */  -- /* -SS- OTR was PS_TRANE_ACCOUNTS */
	...
	GROUP BY
		CASE
			WHEN A.R12_ENTITY NOT IN('5773', '5588') THEN 'USA'
			ELSE 'CAN'
		END
		-- -SS- ASX.NATION_CURR
		,
		...
		,
		PSA.DESCR
	) SALES ON BEGBALANCES.R12_ACCOUNT = SALES.R12_ACCOUNT
	INNER JOIN
	(
