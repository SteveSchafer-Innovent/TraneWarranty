SELECT
	...
	INNER JOIN PROD_CODE_XREF_RCPO_DR /* OTR_PROD_CODE_XREF_RCPO */ PRODGRP     ON 'CSD' = PRODGRP.GL_LEDGER -- -SS- issue 22
	...
	WHERE
		...
		AND(GLA.PS_ACCOUNT LIKE '52%'
		OR GLA.PS_ACCOUNT LIKE '53%'
		OR GLA.PS_ACCOUNT LIKE '54%')))
		-- -SS- /NEW
		/* NATION CURRENCY */
